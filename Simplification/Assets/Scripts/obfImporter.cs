...
public class obfImporter : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //On calcule ensuite le plus �loign� gr�ce � la magnitude (vu que l'on est centr� en 0,0,0)
        foreach (Vector3 v in arrVertices)
        {
        ...
        //On normalise la taille de l'objet gr�ce a biggest
        for (int i = 0; i < arrVertices.Length; i++)
        {
        ...
        // On r�serve de l'espace pour les normales (initialis� a 0,0,0)
        Vector3[] vertexNormal = new Vector3[verticesList.Count];
        int[] triCountVert = new int[verticesList.Count];

        for (int i = 0; i < triangles.Count; i += 3)
        {
            //Array pour pouvoir it�rer dessus plus tard
            ...
            //On calcule les deux c�t�s du triangle
            ...
            //On calcule la normale � la surface
